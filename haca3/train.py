...
def main(args=None):
    ...
    # ====== 1. INITIALIZE MODEL ======
    haca3 = HACA3(beta_dim=args.beta_dim, contrast_dim=args.contrast_dim, eta_dim=args.eta_dim,
                  pretrained_haca3=args.pretrained_haca3, pretrained_eta_encoder=args.pretrained_eta_encoder, contrast_encoder=contrast_encoder,
                  gpu_id=args.gpu_id)
